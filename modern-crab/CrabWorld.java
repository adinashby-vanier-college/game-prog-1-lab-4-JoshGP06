...
public class CrabWorld extends World
{
    ...
    private void prepare()
    {
        ...
        Crab crab2 =  new Crab();
        addObject(crab2, 423, 498);
        removeObject(crab2);
        Worm worm8 =  new Worm();
        addObject(worm8, 269, 419);
        Worm worm9 =  new Worm();
        addObject(worm9, 211, 173);
        Worm worm10 =  new Worm();
        addObject(worm10, 246, 68);
        Worm worm11 =  new Worm();
        addObject(worm11, 57, 215);
        Worm worm12 =  new Worm();
        addObject(worm12, 27, 362);
        Worm worm13 =  new Worm();
        addObject(worm13, 405, 373);
        Worm worm14 =  new Worm();
        addObject(worm14, 474, 236);
        Worm worm15 =  new Worm();
        addObject(worm15, 312, 281);
        Worm worm16 =  new Worm();
        addObject(worm16, 187, 512);
        Worm worm17 =  new Worm();
        addObject(worm17, 240, 262);
        Worm worm18 =  new Worm();
        addObject(worm18, 140, 110);
        Worm worm19 =  new Worm();
        addObject(worm19, 446, 464);
    }
}
